#!/usr/bin/env python3
"""
Run report interpretation table migration
"""
import os
import sys
import psycopg2
...
def main():
    ...
    print("=" * 70)
    print("Report Interpretation Table Migration")
    print("=" * 70)

    # Read SQL file
    sql_file = os.path.join(os.path.dirname(__file__), 'create_report_interpretation_table.sql')
    ...
    try:
        ...
        print("\nCreated table:")
        print("   1. patient_report_interpretation_t - AI interpretation cache")
        print("\nCreated indexes:")
        print("   - patient_id")
        print("   - report_id")
        print("   - UNIQUE (patient_id, report_id, tenant_id) WHERE delete_flag != 'Y'")
        print("   - tenant_id")
