#!/usr/bin/env python3
"""
Run knowledge_file_card_t table creation migration
"""
import os
import sys
import psycopg2
...
def main():
    ...
    print("=" * 70)
    print("Knowledge File Card Table Migration")
    print("=" * 70)
    
    # Read SQL file
    sql_file = os.path.join(os.path.dirname(__file__), 'create_knowledge_file_card_table.sql')
    ...
    try:
        ...
        if cursor.description:
            ...
            if results:
                print("\n📊 Migration results:")
                print("Total Cards | Tenant Count | Knowledge Base Count")
                print("-" * 60)
                for row in results:
