#!/usr/bin/env python3
"""
Run VLM model ID migration for ag_tenant_agent_t table
"""
import os
import sys
import psycopg2
...
def main():
    ...
    print("=" * 70)
    print("Agent VLM Model ID Migration")
    print("=" * 70)
    
    # Read SQL file
    sql_file = os.path.join(os.path.dirname(__file__), 'add_vlm_model_id_to_agent.sql')
