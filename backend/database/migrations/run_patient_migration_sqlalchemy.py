#!/usr/bin/env python3
"""
Run patient management tables migration using SQLAlchemy
"""
import os
import sys
...
def main():
    ...
    print("=" * 70)
    print("Patient Management Tables Migration (SQLAlchemy)")
    print("=" * 70)
    ...
    try:
        ...
        with get_db_session() as session:
            ...
            if rows:
                ...
                print("\n⚠️  Warning: No patient tables found after migration")
