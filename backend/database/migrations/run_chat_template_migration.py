...
"""
Run chat template table migration
"""
...
def main():
    ...
    print("=" * 70)
    print("Chat Template Table Migration")
    print("=" * 70)

    # Read SQL file
    sql_file = os.path.join(os.path.dirname(__file__), 'create_chat_template_table.sql')
    ...
    try:
        ...
        print("\n📝 Created table:")
        print("   1. chat_template_t  - Doctor chat templates with slash commands")

        print("\n📊 Created indexes:")
        print("   - (user_id, tenant_id) on chat_template_t")
        print("   - (tenant_id, slash_command) on chat_template_t")
