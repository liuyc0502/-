...
async def revoke_regular_user(user_id: str, tenant_id: str) -> None:
    ...
    try:
        ...
        try:
            ...
            logging.error(
                f"Failed deleting memory user configs for user {user_id}: {e}")
        ...
        try:
            ...
            logging.error(
                f"Failed deleting conversations for user {user_id}: {e}")
