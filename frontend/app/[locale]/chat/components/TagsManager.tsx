...
export function TagsManager({
  ...
  // Update tags when prop changes (only if different and not from internal update)
  useEffect(() => {
    // Skip if update is from internal change to avoid infinite loop
    ...
    if (currentTagsSorted !== tagsSorted) {
      setTags(currentTags || []);
    }
