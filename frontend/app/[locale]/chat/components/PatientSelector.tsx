...
// Track pending patient selection before conversation is created
...
export function PatientSelector({
  ...
  // Auto-save pending selection when conversationId becomes available
  useEffect(() => {
  ...
  // Show hint when no conversation exists
