...
export const conversationService = {
  ...
  async updateStatus(params: {
    ...
    const response = await fetch(API_ENDPOINTS.conversation.updateStatus, {
      method: 'PUT',
      headers: getAuthHeaders(),
      body: JSON.stringify(params),
    });
  ...
  async updateTags(params: {
    ...
    const response = await fetch(API_ENDPOINTS.conversation.updateTags, {
      method: 'PUT',
      headers: getAuthHeaders(),
      body: JSON.stringify(params),
    });
  ...
  async updateSummary(params: {
    ...
    const response = await fetch(API_ENDPOINTS.conversation.updateSummary, {
      method: 'PUT',
      headers: getAuthHeaders(),
      body: JSON.stringify(params),
    });
