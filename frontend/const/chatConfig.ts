...
messageTypes: {
  ...
  CONSULTATION_AGENT_STEP: "consultation_agent_step" as const,
  CONSULTATION_AGENT_OPINION: "consultation_agent_opinion" as const,
  CONSULTATION_ROUND_COMPLETE: "consultation_round_complete" as const,
  CONSULTATION_WAITING_DOCTOR: "consultation_waiting_doctor" as const,
  CONSULTATION_RECOMMENDATION: "consultation_recommendation" as const,
  KNOWLEDGE_GRAPH_START: "knowledge_graph_start" as const,
  KNOWLEDGE_GRAPH_ENTITIES: "knowledge_graph_entities" as const,
  KNOWLEDGE_GRAPH_RELATIONS: "knowledge_graph_relations" as const,
  KNOWLEDGE_GRAPH_COMPLETE: "knowledge_graph_complete" as const,
  TRAJECTORY_PREDICTION: "trajectory_prediction" as const,
  TRAJECTORY_ANOMALY: "trajectory_anomaly" as const,
...
contentTypes: {
  ...
  CONSULTATION_RECOMMENDATION: "consultation_recommendation" as const,
  KNOWLEDGE_GRAPH: "knowledge_graph" as const,
  MEMORY_SEARCH: "memory_search" as const,
  PREPROCESS: "preprocess" as const,
},
